    ...
    <div className="w-full max-w-2xl mx-auto border rounded-lg p-4 shadow-md ">
      ...
      <form action="" onSubmit={handleSubmit}>
        ...
        <div className="text-grayOne  py-4 ">
          <label
            htmlFor="image"
            className="font-semibold block text-center bg-grayOne text-bgcolor w-[50%] border-black border-1 rounded-md"
          >
            upload Image{" "}
          </label>
        ...
        <div>
          {imagePrev ? (
            <img src={imagePrev ? imagePrev : ""} alt="image prev" />
          ) : (
            ""
          )}
        </div>

        <label htmlFor="" className="font-semibold text-grayOne text-centre">
          Blog content
        </label>
        <br />
  ...
  >
    P
          ...
          <button
            ...
            onClick={() =>
              editor
                .chain()
                .focus()
                .insertContent([{ type: "hardBreak" }, { type: "hardBreak" }])
                .run()
            }
            className={`${buttonStyle} px-3 py-1 border rounded bg-gray-500`}
          >
        ...
        <div className="my-4">
          <button
            type="submit"
            className="bg-primary rounded-lg px-6 py-2 flex justify-center text-center"
          >
            {loading ? (
