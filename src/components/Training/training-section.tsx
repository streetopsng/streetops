...
const features = [
  {
    ...
    description: "We design learning experiences that honour your organization's unique culture and values, ensuring every session resonates authentically.",
    icon: <Target className="w-5 h-5 text-[#F28C8C]" />,
  },
  {
    title: "Behavioural Science Foundation",
    description: "Our programs are grounded in proven behavioural sciences principles, using evidence-based techniques that drive real change.",
    icon: <Brain className="w-5 h-5 text-[#F28C8C]" />,
  },
  {
    title: "Expert-Led Facilitation",
    description: "Led by seasoned facilitators who blend deep expertise with genuine human connection, creating safe spaces for growth.",
    ...
    <section className="relative py-12 bg-white overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-10">
          <h2 className="text-3xl md:text-4xl font-bold text-[#4A1010] Hero mb-3 tracking-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            <div 
              key={index} 
              className="bg-[#FFF8F7] rounded-[24px] p-6 flex flex-col items-center text-center transition-transform hover:scale-[1.01] duration-300 border border-[#FAD9D9]/30"
            >
              {/* Smaller Icon Circle */}
