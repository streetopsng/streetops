        ...
        <div className="relative">
          ...
          <div className="space-y-32">
            {businessTypes.map((item, index) => (
              <div key={index} className="relative flex items-center min-h-20">
                {item.position === "left" ? (
                  <>
                    {/* Left side - title and description */}
                    <div className="flex-1 text-right md:pr-8 pr-4 mr-8 ">
                      <h3 className="text-xl md:text-2xl font-bold Hero text-white mb-1">
                        {item.title}
                      </h3>
                      <p className="text-white/60 text-sm max-w-50 ml-auto">
                        {item.description}
                      </p>
                    </div>
                    ...
                    <div className="flex-1 pl-8 flex items-center">
                      <div
                        className="md:w-24 w-0 h-0"
                        style={{
                          borderTop: "2px dashed rgba(196, 30, 58, 0.4)",
                        }}
                      />
                      <span
                        className="text-6xl md:text-8xl font-bold md:ml-4"
                        style={{ color: "rgba(196, 30, 58, 0.2)" }}
                      >
                        {item.number}
                      </span>
                    </div>
                  ...
                  <>
                    ...
                    <div className="flex-1 md:pl-8 pl-4 ml-8 ">
                      <h3 className="text-xl md:text-2xl font-bold text-white mb-1">
                        {item.title}
                      </h3>
                      <p className="text-white/60 text-sm max-w-50">
                        {item.description}
                      </p>
                    </div>
                  </>
