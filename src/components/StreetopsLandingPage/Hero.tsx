      ...
      <div className="hero">
        ...
        <div className="hvis">
          ...
          <div className="hc hc3">
            ...
            <div className="cteam">
              <div className="ctr">
                <div className="cav" style={{ background: "#E50000" }}>
                  AO
                </div>
                <div style={{ flex: 1 }}>
              ...
              <div className="ctr">
                <div className="cav" style={{ background: "#991B1B" }}>
                  TA
                </div>
                <div style={{ flex: 1 }}>
              ...
              <div className="ctr">
                <div className="cav" style={{ background: "#5A0000" }}>
                  EK
                </div>
                <div style={{ flex: 1 }}>
