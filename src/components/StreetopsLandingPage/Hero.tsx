        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            <div className="hero">
                <div>
                    ...
                    <h1>Your teams deserve a manager who can <i>actually see them.</i></h1>
                    <p className="hbody">StreetOps gives managers real-time visibility into the human dynamics inside their teams — so they can build culture, reduce attrition, and drive performance with confidence.</p>
                    <div className="hform">
                        <input className="hinp" type="email" placeholder="Enter your work email" />
                        <button className="hbtn">Request demo →</button>
                    </div>
                    <p className="hnote">No commitment required. <a href="#">Privacy Policy</a> applies.</p>
                </div>
                <div className="hvis">
                    ...
                    <div className="hc hc1">
                        ...
                        <div className="cbars">
                            <div className="cbr">
                                ...
                                <div className="cbt"><div className="cbf" style={{ width: `${stats.trust}%`, transition: 'width 1s ease-out' }}></div></div>
                            </div>
                            <div className="cbr">
                                <span className="cbn">Connection</span>
                                <div className="cbt"><div className="cbf" style={{ width: `${stats.connection}%`, transition: 'width 1s ease-out' }}></div></div>
                            </div>
                            <div className="cbr">
                                <span className="cbn">Recognition</span>
                                <div className="cbt"><div className="cbf" style={{ width: `${stats.recognition}%`, transition: 'width 1s ease-out' }}></div></div>
                            </div>
                        </div>
                    </div>
