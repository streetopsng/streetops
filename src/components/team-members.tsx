...
//               <motion.div
//                 key={item.name}
//                 className="flex flex-col justify-center items-center w-[48%] perspective"
//                 variants={itemVariants}
//                 initial={isEven ? "hiddenLeft" : "hiddenRight"}
//                 whileInView="visible"
//                 viewport={{ once: true, amount: 0.2 }}
//               >
//                 <div className="flip-card-mobile  h-50 w-50">
//                   {/* FRONT */}
//                   <img
//                     className="flip-face front w-full h-full object-cover bg-gray-200 rounded-sm "
//                     loading="lazy"
//                     src={item.img}
//                     alt={item.name}
//                   />
...
//                   {/* BACK */}
//                   <img
//                     className="flip-face back w-full h-full object-cover bg-gray-200 rounded-sm"
//                     loading="lazy"
//                     src={"/car-test.png"}
//                     alt={`${item.name} back`}
//                   />
...
//                   setMouseLeave(true);
//                 }}
//                 className="opacity-0  rounded-sm cursor-pointer perspective "
//                 ref={(el: HTMLDivElement) => {
//                   imageContainerRef.current[index] = el;
//                 }}
//               >
