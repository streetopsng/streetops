  ...
  return (
    <>
      ...
      <div className="py-[88px] px-20">
        <div className="bg-char dark:bg-[#0A0600] border border-[rgba(255,248,238,0.07)] border-l-4 border-l-red-600 p-13 rounded-lg flex gap-13 items-center rv">
          <div className="flex-1">
            ...
            <h2 className="font-serif text-[30px] font-light leading-[1.1] mb-3.5 tracking-[-0.6px] text-cream">
              A cohort that builds your culture from the inside out.
            </h2>
            <p className="text-[14.5px] leading-[1.68] font-light mb-6 text-cream/50">
          ...
          <div className="w-[300px]">
            {[
              ...
              <div
                key={index}
                className="py-3 border-b border-[rgba(255,248,238,0.07)] flex"
              >
                <span className="text-[9.5px] font-bold tracking-[2px] uppercase w-[72px] flex-shrink-0 pt-px text-cream/20">
                  {item.label}
                </span>
      ...
      <div className="py-[88px] px-20 bg-[#FFF2E0] dark:bg-[#241800]">
        ...
        <div className="grid grid-cols-2 gap-2.5 mt-11 rv rv2">
          {[
            {
              icon: "🎯",
            ...
            <div
              key={index}
              className="p-7 border border-[rgba(26,15,0,0.08)] dark:border-[rgba(255,248,238,0.08)] rounded-lg transition-all hover:border-red-600 bg-white dark:bg-[#1C1200]"
            >
              <span className="text-2xl mb-3 block">{item.icon}</span>
              <div className="text-[14px] font-semibold mb-1.5 text-char dark:text-cream">
                {item.title}
              </div>
              <div className="text-[13px] leading-[1.62] font-light text-ink3 dark:text-[rgba(255,248,238,0.42)]">
                {item.desc}
              </div>
            </div>
          ))}
