...
export default function ServicesPage() {
  ...
  return (
    <>
      ...
      {/* Methodology */}
      <div className="py-[88px] px-20 bg-[#FFF2E0] dark:bg-[#241800]">
        ...
        <h2 className="font-serif text-[clamp(28px,3.8vw,46px)] font-light leading-[1.1] tracking-[-0.7px] mb-[18px] rv rv1 text-char dark:text-cream">
          The methodology behind
          <br />
          <em className="not-italic text-terra">every engagement.</em>
        </h2>
        <div className="grid grid-cols-4 gap-0 border border-[rgba(26,15,0,0.08)] dark:border-[rgba(255,248,238,0.08)] rounded overflow-hidden mt-12 rv rv2">
          {[
            {
              title: "Diagnose",
            ...
            <div
              key={index}
              className="p-9 border-r last:border-r-0 border-[rgba(26,15,0,0.08)] dark:border-[rgba(255,248,238,0.08)] transition-all hover:bg-red-50 dark:hover:bg-red-900/15"
            >
              <div className="font-serif text-[11px] italic mb-3.5 flex items-center gap-2 text-terra">
                <div className="w-[18px] h-px bg-terra" />
                {item.title}
              </div>
              <h3 className="font-serif text-[19px] font-normal mb-2 tracking-[-0.2px] text-char dark:text-cream">
                {item.subtitle}
              </h3>
      ...
      <div className="py-[88px] px-20 rv">
        ...
        <div className="grid grid-cols-3 auto-rows-auto gap-3 mt-12 rv rv1">
          {services.map((service) => (
            ...
            >
              ...
              <h3
                className={`font-serif text-[18px] font-normal mb-2.5 tracking-[-0.1px] leading-[1.2] ${service.featured ? "text-white" : "text-char"}`}
              >
                {service.title}
              </h3>
              <p
                className={`text-[13px] leading-[1.62] font-light flex-1 mb-4 ${service.featured ? "text-white/60" : "text-ink3"}`}
              >
                {service.description}
              </p>
      ...
      <div className="py-25 px-20 text-center relative overflow-hidden bg-char dark:bg-[#0A0600]">
        ...
        <p className="text-base mb-9 font-light relative z-10 text-cream/40">
